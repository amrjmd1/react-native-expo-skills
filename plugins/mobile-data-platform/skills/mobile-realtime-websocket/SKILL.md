...
description: Realtime communication guidance for mobile apps. Use for WebSocket lifecycle, reconnect strategy, presence/state sync, message ordering guarantees, backpressure, and foreground/background transitions.
---

# Mobile Realtime WebSocket Patterns

## Mission
Implement stable realtime features under mobile network volatility.

## Workflow
1. Define connection lifecycle by app state.
2. Implement reconnect/backoff and resume semantics.
3. Guarantee message ordering and deduplication policy.
4. Handle backpressure and subscription fanout safely.
