...
description: Background processing and notification guidance for mobile apps. Use for task scheduling, push notification architecture, token lifecycle, delivery reliability, and iOS/Android background execution constraints.
---

# Background Tasks and Notifications

## Mission
Implement background capabilities and notifications with platform-safe reliability.

## Workflow
1. Map feature requirements to OS background capabilities.
2. Design push pipeline and token registration lifecycle.
3. Define retry, dedupe, and delivery confirmation behavior.
4. Handle permission/opt-out states with clear UX.
